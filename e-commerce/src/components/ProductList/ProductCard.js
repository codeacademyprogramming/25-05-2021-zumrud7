...
import { loadAsyncAction, addBasketItems } from "../../actions/action";
// import { addBasketItems } from "../../actions/action";
...
export default function ProductCard() {
  ...
  const handleAddToBasket = (prod) => {
    dispatch(
      addBasketItems([prod.id, prod.name, prod.image, prod.price, productSize])
    );
  };
  ...
  return (
    ...
    products.map((prod) => {
      return (
        <div className="col-md-6 col-lg-4 col-xl-3" key={prod.id}>
          <div className="product-card">
            <div className="photo">
              <img src={prod.image} alt="" />
            </div>
            <h5 className="card-title">
              {prod.name} <span>32cm</span>
            </h5>
            <p className="description">{prod.topping}</p>
            <p className="price">{prod.price} UAH</p>
            <button className="btn-detail">
              ...
              >
                ...
                <defs>
                  ...
                  >
                    <stop stopColor="#FE5626" />
                    <stop offset="1" stopColor="#F23F0E" />
                  </linearGradient>
                  <linearGradient
                    id="paint1_linear"
                    x1="6.22278"
                    ...
                    gradientUnits="userSpaceOnUse"
                  >
                    <stop stopColor="#F58656" />
                    <stop offset="1" stopColor="#FE5626" />
                  </linearGradient>
                </defs>
              </svg>
            </button>
            <div className="overlay">
              <ul>
                ...
                <li>
                  ...
                  />
                  <label htmlFor={`small-${prod.id}`}>small - 20cm</label>
                </li>
                <li>
                  <input
                    type="radio"
                    ...
                    onChange={handleChange}
                  />
                  <label htmlFor={`medium-${prod.id}`}>medium - 25cm</label>
                </li>
                <li>
                  <input
                    type="radio"
                    ...
                    onChange={handleChange}
                  />
                  <label htmlFor={`large-${prod.id}`}>big - 32cm</label>
                </li>
              </ul>
              <button
                className="btn-orange btn-add-to-cart"
